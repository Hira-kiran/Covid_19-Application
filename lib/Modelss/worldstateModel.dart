// ignore_for_file: unnecessary_this, file_names, unnecessary_new, prefer_collection_literals

class WoldStateApiModel {
  int? updated;
  int? cases;
  int? todayCases;
  int? deaths;
  ...
  WoldStateApiModel.fromJson(Map<String, dynamic> json) {
